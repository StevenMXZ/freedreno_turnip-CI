...
prepare_source(){
    ...
    # Configuração de identidade (evita erro fatal do git)
    echo "Configuring Git Identity..."
    git config user.email "ci@turnip.builder"
    git config user.name "Turnip CI Builder"

    # --- APLICANDO O PATCH A830 (Modo Tolerante) ---
...
EOF
    ...
    # Aplica o patch (usando apply --ignore-whitespace para evitar erro "corrupt patch")
    git apply --ignore-space-change --ignore-whitespace ../a830_all.patch || {
