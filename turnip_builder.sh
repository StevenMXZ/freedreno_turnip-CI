...
prepare_source(){
	...
	# Clone raso do branch 'main' (o mais recente)
...
{
  "schemaVersion": 1,
  "name": "Turnip (Main) - $date_meta - $short_hash",
  "description": "Built from Mesa main branch. Commit $commit_hash",
  "author": "mesa-ci",
...
generate_release_info() {
    ...
    echo "Turnip CI Build - ${date_tag} (Mesa Main)" > release
...
echo -e "${green}🎉 Build completed successfully!${nTopocolor}"
