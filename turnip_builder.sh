...
prepare_source(){
	...
	# --- APLICAR O PATCH VK 1.4 (com sed) ---
...
compile_mesa(){
	echo -e "${green}⚙️ Compiling Mesa (Main + VK1.4 Patch)...${nocolor}"
	...
	cat <<EOF > meta.json
{
  "schemaVersion": 1,
  "name": "$meta_name",
  "description": "Built from Mesa main + A6xx VK1.4 Patch. Commit $commit_hash",
  "author": "mesa-ci",
...
generate_release_info() {
    ...
    echo "Turnip CI Build - ${date_tag} (Main + A6xx VK1.4 Patch)" > release
